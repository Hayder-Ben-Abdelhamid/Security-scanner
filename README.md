...
Since we just added a new file, your local Git repository will want to track it. Run these quick commands in your terminal to update your online project repository:

```bash
git add README.md
git commit -m "Docs: Add README markdown documentation"
